...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/admin.php?s=/Implant';
	    var APP	 = '/admin.php?s=';
	    var SELF='/admin.php?s=/Implant/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">           
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加种植</button>              
